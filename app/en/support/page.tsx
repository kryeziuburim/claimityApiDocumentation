        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-16 pt-10 md:pb-20 md:pt-16 lg:pb-24 lg:pt-20">
          ...
          <div className="mt-10 rounded-2xl border border-slate-200 bg-white/80 shadow-sm backdrop-blur-xl">
            <div className="border-b border-slate-200 px-6 py-6">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Answers to the most frequently asked questions about using Claimity.
              </p>
            </div>
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="faq-1">
                  ...
                  <AccordionContent className="text-gray-600">
                    You can filter by cases assigned to you in the case list next to the search field.
                    This allows you to keep track of your responsibilities.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="faq-2">
                  <AccordionTrigger className="text-gray-900">
                    How do I add more users to Claimity?
                  </AccordionTrigger>
                  <AccordionContent className="text-gray-600">
                ...
                <AccordionItem value="faq-3">
                  ...
                  <AccordionContent className="text-gray-600">
                    As an organization admin, you can remove existing users in the organization settings. They will then no longer have access to your data.
                    However, there must always be at least one admin user who can manage the organization.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="faq-4">
                  <AccordionTrigger className="text-gray-900">
                    How do I receive notifications about significant activities?
                  </AccordionTrigger>
                  <AccordionContent className="text-gray-600">
                    As an organization admin, you can enable email notifications in the organization settings. For integrations,
                    webhooks are also available in the API.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="faq-5">
                  ...
                  <AccordionContent className="text-gray-600">
                    Yes. The API documentation describes endpoints, data models, and webhooks. Example snippets help
                    with a quick start.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="faq-6">
                  ...
                  <AccordionContent className="text-gray-600">
                    Use the support form below. For critical disruptions, please also note the status indication
                    in your report.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
          ...
          <div className="mt-12 rounded-2xl border border-slate-200 bg-white/80 shadow-sm backdrop-blur-xl">
            <div className="border-b border-slate-200 px-6 py-6">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Didn't find a suitable answer? Send us the details – we will get back to you promptly.
              </p>
            </div>
            <div className="px-6 py-6">
